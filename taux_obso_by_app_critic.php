<?php
	...
	shell_exec("rm -f /var/www/html/taux_obso_by_app_critic.html");	
...
<head>
	<title>Taux obsolescence par Application critique</title>
...
<body>
    ...
    <?php
        $querylistapp = "select application from cmdb.application where criticity = 1 and archived = 0;";
	...
	<div style='text-align:center;'>
		<h4 class="jumbotron">Taux obsolescence par Application CRITIQUE</h4><br />
	...
	<div>
		<center>
            ...
            <?php 
					...
					writeTextFile("/var/www/html/taux_obso_by_app_critic.html",$content);//recuperation du nom pour nommer le document
					ob_clean();					
					ob_start();				
				?>
