			...
			<div class="tab-content">
				...
				<div class="form_style">
							...
							if(!empty($comments)) 
							{
								foreach($comments as $k=>$v) 
								{
									...
									<div class="message-box" id="message_<?php echo $comments[$k]["id"];?>">
										<div>
											<button class="btnEditAction" name="edit" onClick="showEditBox(this,<?php echo $comments[$k]["id"]; ?>)">Editer</button>
											<button class="btnDeleteAction" name="delete" onClick="callCrudAction('delete',<?php echo $comments[$k]["id"]; ?>)">Supprimer</button>
										</div>
									<div class="message-content">
										<?php echo $comments[$k]["message"]; ?></div>
									</div>
									<?php
								}
							} 
					...
					<div id="frmAdd">
						...
						<p>
						<button id="btnAddAction" name="submit" onClick="callCrudAction('add','')">Ajouter</button></p>
					</div>
